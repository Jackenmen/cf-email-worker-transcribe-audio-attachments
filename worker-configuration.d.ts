/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .dev.vars.example` (hash: a801fba3177a8f7dfb7b47d29e17e3ad)
// Runtime types generated with workerd@1.20250823.0 2024-04-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		EXPECTED_FROM_EMAIL: string;
		FROM_EMAIL: string;
		TO_EMAIL: string;
		SEB: SendEmail;
		AI: Ai;
